...
const listQueueTwo = new LinkedListQueue();
listQueueTwo.seed([1, 2, 9, 3, 3, 5]);

// console.log(isSumOfHalvesEqual(arrayQueueOne));
// arrayQueueOne.print();

// console.log(isSumOfHalvesEqual(arrayQueueTwo));
// arrayQueueTwo.print();

console.log(isSumOfHalvesEqual(listQueue));
listQueue.print();

console.log(isSumOfHalvesEqual(listQueueTwo));
listQueueTwo.print();
