...
// const singleNodeList = new DoublyLinkedList().insertAtBack(1).toArray();
// console.log(singleNodeList);
// const biNodeList = new DoublyLinkedList().insertAtBack(1).insertAtBack(2).toArray();
// const triNodeList = new DoublyLinkedList().insertAtBack(1).insertAtBack(2).insertAtBack(3).toArray();
// console.log(biNodeList);
// console.log(triNodeList);
...
let dlList = new DoublyLinkedList().insertAtFront(2).insertAtFront(1);
dlList.insertAtBack(3).insertAtBack(4);
console.log(dlList.toArray());
console.log(dlList.removeMiddleNode());
